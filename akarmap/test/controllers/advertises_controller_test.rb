...
class AdvertisesControllerTest < ActionController::TestCase
  ...
  test "should create advertise" do
    assert_difference('Advertise.count') do
      post :create, advertise: { address: @advertise.address, city: @advertise.city, desc: @advertise.desc, type: @advertise.type, user_id: @advertise.user_id }
    end
  ...
  test "should update advertise" do
    patch :update, id: @advertise, advertise: { address: @advertise.address, city: @advertise.city, desc: @advertise.desc, type: @advertise.type, user_id: @advertise.user_id }
    assert_redirected_to advertise_path(assigns(:advertise))
  end
